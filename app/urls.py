...
urlpatterns = [
    ...
    path('api/ai/track-view/',       views.ai_track_product_view,  name='ai-track-view'),
    path('api/ai/recently-viewed/',  views.ai_recently_viewed_api, name='ai-recently-viewed'),
    path('api/ai/guest-recommend/',  views.ai_guest_recommend_api, name='ai-guest-recommend'),
    path('api/ai/my-profile/',       views.ai_user_profile_api,    name='ai-user-profile'),
    ...
    path('auth/facebook/', views.facebook_login, name='facebook-login'),
    path('auth/facebook/callback/', views.facebook_callback, name='facebook-callback'),
    ...
    path('auth/social/complete/', views.social_complete, name='social-complete'),
